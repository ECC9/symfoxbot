...
bot.on('message', (message) => {
    ...
    switch (args[0].toLowerCase()) {
        ...
        case "help":
           ...
           message.author.send("Here are all of the commands expect the secret commands. To request command(s) send mail to `galbence2002@gmail.com`");
           message.author.send("Want to invite me to you'r server? Say `;;symfox` then you get the invitation link :D");
           var embed = new Discord.RichEmbed()
        ...
        case "error":
            ...
            break;
        case "invite":
            message.channel.send("You'r Invitation Link: ```https://discord.gg/MqQEnRu``` ");
            break;
        case "afk":
